...
php /usr/local/php-scripts/src/update-data/update-tips.php token=$token > $pipe_tips &


php /usr/local/php-scripts/src/update-data/update-employees.php token=$token > $pipe_employees &
pid_employees=$!
...
php /usr/local/php-scripts/src/update-data/update-customers.php token=$token > $pipe_customers &
pid_customers=$!


php /usr/local/php-scripts/src/update-data/update-events.php token=$token > $pipe_events &
...
php /usr/local/php-scripts/src/update-data/update-clothes.php token=$token > $pipe_clothes &


php /usr/local/php-scripts/src/update-data/update-encounters.php token=$token > $pipe_encounters &
