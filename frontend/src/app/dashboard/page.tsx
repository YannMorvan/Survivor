        ...
        <div className="mt-5">
          ...
          >
            ...
            >
              ...
              <li>
                <p
                  onClick={() => setLastDays("10 derniers jours")}
                  className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                >
                  10 derniers jours
                </p>
              ...
              <li>
                <p
                  onClick={() => setLastDays("5 derniers jours")}
                  className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                >
                  5 derniers jours
                </p>
              ...
              <li>
                <p
                  onClick={() => setLastDays("dernier jour")}
                  className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                >
                  dernier jour
                </p>
        ...
        <div className="bg-white rounded-sm p-5 mt-5 lg:w-7/12 border lg:mr-7">
          <div className="flex xs:justify-between">
            ...
            <div className="flex border rounded overflow-hidden">
              <p
                className={`text-xs border px-2 py-1 cursor-pointer ${getButtonStyle(
                  "7J"
                )}`}
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <li>
                    <p
                      onClick={() => setSelectedMapPeriod("1 jour")}
                      className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                    >
                      1 jour
                    </p>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <li>
                    <p
                      onClick={() => setSelectedMeetingsPeriod("1 jour")}
                      className="cursor-pointer block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                    >
                      1 jour
                    </p>
