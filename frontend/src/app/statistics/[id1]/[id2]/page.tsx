        ...
        const fetchData1 = async () => {
            try {
                ...
                all_encounters.forEach((encounter: Encounters) => {
                  const customer = data.coach.customers.find((cust: Client) => cust.id === encounter.client_id);
                ...
                const avgStar = all_encounters.reduce((sum, encounter) => sum + encounter.rating, 0) / all_encounters.length;
    ...
    return (
        ...
        <div className='mt-5'>
            <div className='lg:flex min-w-screen'>
                ...
                <div className='flex justify-between'>
                    <div>
                        ...
                        <div>
                            ...
                            <div className='mt-2 flex'>
                                <div>
                                    <p className='xl:text-6xl lg:text-xl md:text-lg'>{avgStar1.toPrecision(2)}</p>
                                </div>
                                <div>
                    ...
                    <div>
                        ...
                        <div className='mt-2 flex'>
                            <div>
                                <p className='xl:text-6xl lg:text-xl md:text-lg'>{avgStar2.toPrecision(2)}</p>
                            </div>
                            <div>
            ...
            <div className='lg:flex w-full'>
                ...
                {Encounters1.length === 0 || Encounters2.length === 0 ? (
                        <div className='flex h-full justify-center items-center'>
                            <p className='text-xl text-slate-300'>Aucune données à afficher pour {data1?.name}</p>
                        </div>
                    ) : (
                        <div className='mt-1'>
                            <p className='font-bold mb-5'>Dernières Reviews de {data1?.name}</p>
            ...
            {Encounters2.length === 0 || Encounters1.length === 0 ? (
                    <div className='flex h-full justify-center items-center'>
                        <p className='text-xl text-slate-300'>Aucune données à afficher pour {data2?.name}</p>
                    </div>
                ) : (
                    <div className='mt-1'>
                        <p className='font-bold mb-5'>Dernières Reviews de {data2?.name}</p>
