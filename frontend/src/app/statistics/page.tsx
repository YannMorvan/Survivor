        ...
        <div className='mt-5'>
            <div className='lg:flex min-w-screen'>
                ...
                <div className='flex'>
                    ...
                    <p className='ml-1'>points from last month</p>
                </div>
                <div className='mt-5'>
                    <Price />
                </div>
                ...
                <div className='lg:w-2/3 lg:ml-4 lg:mt-0 mt-5 bg-white border border-slate-200 rounded-md p-5'>
                            ...
                            {isDropdownOpen && (
                                <div id="dropdown" className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute mt-2 w-24">
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">1 month</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">1 week</a>
                                        </li>
                                    </ul>
                                </div>
                            )}
                    ...
                    <div className='flex'>
                        ...
                        <div className='mt-1 ml-10'>
                            <p className='text-green-500'>Total Meetings</p>
            ...
            <div className='mt-5 lg:w-2/3 border rounded p-7 bg-white'>
                <div className='mt-1'>
                    <p className='text-bold'>Lastest Review</p>
                </div>
                <div className='mt-8'>
            ...
            <div className='mt-5 lg:ml-5 lg:w-1/3 border rounded p-7 bg-white'>
                <div className='mt-1'>
                    <p className='text-bold'>Next meetings</p>
                </div>
                <div className='mt-10'>
