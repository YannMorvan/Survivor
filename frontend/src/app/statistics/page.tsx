...
export default function Page() {
    ...
    return (
        ...
        <div className='md:flex justify-between'>
            ...
            {isOpen && (
                <div id="dropdownUsers" className="z-10 min-w-20 max-w-44 mt-12 absolute bg-white rounded-lg shadow w-60 dark:bg-gray-700">
            ...
            {isOpen2 && (
                <div id="dropdownUsers2" className="z-10 min-w-20 max-w-44 right-7 mt-12 absolute bg-white rounded-lg shadow w-60 dark:bg-gray-700">
