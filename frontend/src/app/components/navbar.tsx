  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setIsCoach(parsedResponse.isCoach);
      } catch (error) {
        ...
        <div className="max-w-screen p-4 flex items-center justify-between">
          ...
          <div className="flex items-center justify-end md:order-2 space-x-10 md:space-x-0 rtl:space-x-reverse">
            <div className="lg:block hidden mr-5">
              <MessageSquareMore
                onClick={() => setTriggerChat(!triggerChat)}
                className="text-sky-700 cursor-pointer mt-0.5 mr-3"
              />
            </div>
            ...
            <div className="relative inline-block text-left">
              ...
              <div
                ...
                } bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute right-0 mt-2`}
              >
                <ul
                ...
                >
                  <li>
                    <a
                      href="/dashboard"
                      className={`block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white ${getActiveRoute(
                        "/dashboard"
                      )}`}
                    >
                      Tableau
                  ...
                  <li>
                    <div className="flex hover:bg-gray-100">
                      ...
                      <a
                        href="#"
                        className="block py-1 pl-3.5 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        Profile
                      </a>
                    </div>
              ...
              {[
                ...
                .filter(
                  (route) =>
                    !(
                      isCoach &&
                      (route.path === "coaches" || route.path === "statistics")
                    )
                )
                .map((route) => (
