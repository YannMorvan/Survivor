...
const Review = () => {
    return (
        <div className='mt-5 border rounded p-7 bg-white'>
            <div className='mt-1'>
                <p className='font-bold'>Dernières Reviews des clients de Julien</p>
            </div>
            <div className='mt-8'>
                <div className='flex'>
                    ...
                    <div>
                        ...
                        <p className='ml-6 mt-1 text-sm text-slate-400'>Cinema</p>
                        <p className='mt-2 ml-6 text-slate-500'>
