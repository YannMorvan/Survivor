...
export default function Events() {
  ...
  useEffect(() => {
    if (view === "mois") {
      ...
      const monthName = selectedWeek.toLocaleString("default", {
        month: "long",
      });
  ...
  const changeDate = (direction: string) => {
    if (view === "semaine") {
      ...
      const newMonthName = currentDate.toLocaleString("default", {
        month: "long",
      });
      ...
      const currentMonthIndex = new Date(
        Date.parse(currentMonthName + " 1, " + currentYear)
      ).getMonth();
          ...
          <div className="md:flex justify-between">
            <div className="flex">
              <p className="ml-10 mt-5 text-xl font-semibold">
                {view === "semaine"
                  ? `Week of ${selectedWeek.toLocaleDateString("default", {
                      month: "long",
                      day: "numeric",
                      year: "numeric",
                    })}`
                  : view === "jour"
                  ? `Day of ${selectedDay.toLocaleDateString("default", {
                      weekday: "long",
                      day: "numeric",
                      month: "long",
                      year: "numeric",
              ...
              <div id="next">
                <ChevronLeft
                  size={22}
                  className="text-slate-400 cursor-pointer ml-5 mt-6"
            ...
            <div className="flex mt-5 md:ml-0 ml-10">
              <div className="mr-5 flex border rounded overflow-hidden">
                <p
                  className={`text-xs font-semibold text-slate-400 border px-4 py-2 cursor-pointer`}
                  onClick={() => {
                    setView("jour");
